...
export default function RepairDetailsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fcfcfc', fontFamily: 'var(--font-inter, sans-serif)' }}>
      <UserNavbar />

      <main style={{ maxWidth: '900px', margin: '40px auto', padding: '0 24px', paddingBottom: '100px' }}>
        {/* Back Button */}
        <button
          onClick={() => router.back()}
          style={{
